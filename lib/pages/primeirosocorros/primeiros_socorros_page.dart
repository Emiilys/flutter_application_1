...
class _PrimeirosSocorrosPageState extends State<PrimeirosSocorrosPage> {
  ...
  void _pesquisar(BuildContext context) {
    ...
    if (termo.contains('coração') ||
      ...
      Navigator.push(context,
          MaterialPageRoute(builder: (c) => const FerimentosPage()));
      ...
      Navigator.push(context,
          MaterialPageRoute(builder: (c) => const ProblemasNeurologicosPage()));
    } else {
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            LayoutBuilder(builder: (context, constraints) {
              ...
              return GridView.count(
                ...
                children: [
                  GestureDetector(
                    onTap: () => Navigator.push(context, MaterialPageRoute(builder: (c) => const ProblemasCardiacosPage())),
                    child: _categoriaCard('Problemas Cardíacos', '❤️', Colors.red.shade50, Colors.red, Colors.red.shade700),
                  ),
                  GestureDetector(
                    onTap: () => Navigator.push(context, MaterialPageRoute(builder: (c) => const RespiracaoAnsiedadePage())),
                    child: _categoriaCard('Respiração & Ansiedade', '💨', Colors.blue.shade50, Colors.blue, Colors.blue.shade700),
                  ),
                  GestureDetector(
                    onTap: () => Navigator.push(context, MaterialPageRoute(builder: (c) => const FerimentosPage())),
                    child: _categoriaCard('Ferimentos & Trauma', '🩸', Colors.orange.shade50, Colors.orange, Colors.orange.shade700),
                  ),
                  GestureDetector(
                    onTap: () => Navigator.push(context, MaterialPageRoute(builder: (c) => const ProblemasNeurologicosPage())),
                    child: _categoriaCard('Problemas Neurológicos', '🧠', Colors.purple.shade50, Colors.purple, Colors.purple.shade700),
                  ),
                ],
              );
            }),
